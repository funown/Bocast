...
public class DateUtils {
  ...
  public static Date stringToDate(String dt) {
    SimpleDateFormat[] dateFormats = {
        ...
        new SimpleDateFormat("dd MMM yyyy HH:mm:ss Z", Locale.CHINA),
        new SimpleDateFormat("EEE, dd MMM yyyy HH:mm Z", Locale.CHINA),
        new SimpleDateFormat("dd MMM yyyy HH:mm Z", Locale.CHINA)
    };
   ...
   * @return    返回转换后的日期对象
   */
  public static Date stringToDate(String dateString, DatePattern pattern, Locale locale){
    Date date = null;
    SimpleDateFormat sdf = new SimpleDateFormat(pattern.getValue(),locale);
    try {
